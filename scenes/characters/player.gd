...
enum State { MOVING, TACKLING, RECOVERING, PREP_SHOOT, SHOOTING, PASSING, HEADER, VOLLEY_SHOOT, BICYCLE_SHOOT, CHEST_CONTROL, HURT, DIVING, CELEBRATING, MOURNING, RESETING }
